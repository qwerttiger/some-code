...
#image loading
playerright=pygame.image.load("platformer sprites/player.png")
...
def draw(): #this draws the background
  screen.blit(pygame.image.load(f"platformer sprites/level {level}.png"),(0,0))
...
def setuplvl(): #sets up the mask for level
  ...
  file=pygame.image.load(f"platformer sprites/level {level}.png")
